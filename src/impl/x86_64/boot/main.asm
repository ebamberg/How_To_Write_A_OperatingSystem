...
setup_page_tables:
    ...
    mov ecx, 0
loop:
    move eax, 0x200000   ; 2 MB
    mul ecx             ; 2mb * Pointer = physical memory adress
    or eax, 0b10000011  ; set present, writable, huge page
    move [page_table_level2+ecx*8], eax ; set the page address into  the page_table_level2
    inc ecx
    cmp ecx,512
    jne .loop
